...
//           <a href={`#${item.toLowerCase()}`} className="block py-2 text-gray-700 hover:bg-gray-200 rounded-md p-4" key={item}>
//             {item}
//           </a>
//         ))}
//       </nav>
//       <div className="mt-auto">
//         <a href="#settings" className="block py-2 text-gray-700 hover:bg-gray-200 rounded-md p-4">Settings</a>
//         <button
//         onClick={handleLogout}
//         className="block py-2 text-gray-700 hover:bg-gray-200 rounded-md w-full text-left p-4"
//       >
//         Logout
//       </button>
//       </div>
